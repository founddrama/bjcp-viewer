type SRMHex = 'FEE287' | 'FED265' | 'FEC048' | 'FDB335' | 'F9A21C' |
...
export const SRM_VALUES: (SRMHex | undefined)[] = [
        undefined,//0th is sentinel
        'FEE287',
        'FED265',
        'FEC048',
        'FDB335',
...
type BeerColorName = 'Straw' | 'Yellow' | 'Gold' | 'Amber' |
                     'Deep Amber/Light Copper' | 'Copper' |
                     'Deep Copper/Light Brown' | 'Brown' | 'Dark Brown' |
                     'Very Dark Brown' | 'Black' | 'Other Color';

function getColorFromSRM(n: number): BeerColorName {
  switch (n) {
    case 1: case 2:
      return 'Straw';
    case 3: case 4:
